...
/* MAIN BACKGROUND */
.stApp {
    background: linear-gradient(135deg, #fff1ec, #e8fff5);
}

/* REMOVE WEIRD TOP GAP */
...
[data-testid="stButton"] button {
    background: linear-gradient(135deg, #ff8f7a, #8ee6c4);
    color: white;
    border-radius: 18px;
    padding: 0.7rem 1rem;
    border: none;
    font-weight: 700;
    box-shadow: 0 5px 14px rgba(255, 143, 122, 0.25);
}

/* BUTTON HOVER */
[data-testid="stButton"] button:hover {
    background: linear-gradient(135deg, #ff735c, #6fd9b3);
    color: white;
...
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #ffe1dc, #dcfff1);
}
...
st.markdown(
    """
<div style="background: linear-gradient(135deg, #ff8f7a, #8ee6c4);
padding: 30px;
border-radius: 28px;
color: white;
text-align: center;
...
<h1 style="color:white; font-size:46px;">🍰 Blossom & Nandika's Bakery Delights</h1>
<p style="font-size:20px; color:white;">Fresh treats, cute orders, and sweet bakery management ✨</p>
